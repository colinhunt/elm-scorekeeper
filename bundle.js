...
var _user$project$Main$playerPointTotal = F2(
				...
				_elm_lang$core$List$sum(
					A2(
						...
						A2(
							...
							function (play) {
								return _elm_lang$core$Native_Utils.eq(play.playerId, player.id);
							},
							model.plays)))));
	});
...
var _user$project$Main$findPlayer = F2(
	function (players, id) {
		return A2(
...
var _user$project$Main$Play = F3(
	function (a, b, c) {
		return {id: a, playerId: b, points: c};
	});
...
var _user$project$Main$play = F2(
	function (model, play) {
		return A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								function (_) {
									...
									A2(_user$project$Main$findPlayer, model.players, play.playerId))),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$Main$playList = function (model) {
	return A2(
		...
		A2(
			_elm_lang$core$List$map,
			_user$project$Main$play(model),
			model.plays));
};
var _user$project$Main$playsSection = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
